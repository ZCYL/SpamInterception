...
import com.inter.service.DeleteOldMessagesService;
import com.inter.ui.base.BaseActivity;
import com.inter.ui.dialog.DefaultSmsHelper;
import com.inter.ui.dialog.QKDialog;
import com.inter.ui.fragment.ConversationListFragment;
import com.inter.ui.fragment.MMSSetupFragment;
import com.inter.ui.setting.SettingsFragment;
import com.inter.ui.util.ThemeManager;
import com.inter.util.DraftCache;
import com.inter.util.LiveViewManager;
import com.inter.convers.MessageUtils;
import com.inter.util.NotificationManager;
...
//        DonationManager.getInstance(this).destroy();
    ...
    public static class DeleteThreadListener implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialog, final int whichButton) {
            MessageUtils.handleReadReport(mContext, mThreadIds, PduHeaders.READ_STATUS__DELETED_WITHOUT_BEING_READ, new Runnable() {
                @Override
                public void run() {
