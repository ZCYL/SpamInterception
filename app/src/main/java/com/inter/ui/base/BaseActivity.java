        ...
        LiveViewManager.registerView(QKPreference.THEME, this, new LiveView() {
            ...
            public void refresh(String key) {
                ...
                if (mStatusTintEnabled) {
                    getWindow().setStatusBarColor(CommonUtil.darken(ThemeManager.getColor()));
                }
                if (mNavigationTintEnabled) {
                    getWindow().setNavigationBarColor(CommonUtil.darken(ThemeManager.getColor()));
                }
            }
        });
...
//        return ((MyApplication) getApplication()).getRequestQueue();
//    }
}
