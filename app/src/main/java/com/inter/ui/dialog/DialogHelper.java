...
public class DialogHelper {
    ...
    public static void showDeleteConversationDialog(BaseActivity context, long threadId) {
        Set<Long> threadIds = new HashSet<>();
        threadIds.add(threadId);
        showDeleteConversationsDialog(context, threadIds);
    }

    public static void showDeleteConversationsDialog(final BaseActivity context, final Set<Long> threadIds) {
...
//
//    public static void showChangelog(BaseActivity context) {
